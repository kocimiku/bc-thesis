...
def create_slim_IP(input, print_flag=False):
    ...
    slim_IP.linear_constraints.add(names=["total_pos_error"],
                                   lin_expr=[
                                       cplex.SparsePair(ind=[error_names[i] for i in pos_ind] + total_error_pos_name,
                                                        val=[-1.0] * N_pos + [1.0])],
                                   senses="E",
                                   rhs=[0.0])
    ...
    slim_IP.linear_constraints.add(names=["total_neg_error"],
                                   lin_expr=[
                                       cplex.SparsePair(ind=[error_names[i] for i in neg_ind] + total_error_neg_name,
                                                        val=[-1.0] * N_neg + [1.0])],
                                   senses="E",
                                   rhs=[0.0])
    ...
    slim_IP.linear_constraints.add(names=["total_error"],
                                   lin_expr=[cplex.SparsePair(
                                       ind=total_error_name + total_error_pos_name + total_error_neg_name,
                                       val=[1.0, -1.0, -1.0])],
                                   senses="E",
                                   rhs=[0.0])
